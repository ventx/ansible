...
options:
  spool_dir:
    type: string
    default: 'LocalStateDir + “/lib/icinga2/spool/checkresults/”'
    description: 'The directory which contains the check result files. Defaults to LocalStateDir + “/lib/icinga2/spool/checkresults/”.'
