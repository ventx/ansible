...
options:
  ...
  start_time:
    type: int
    required: true
    description: 'The start time as UNIX timestamp.'
  end_time:
    type: int
    required: true
    description: 'The end time as UNIX timestamp.'
  duration:
    type: int
    description: 'The duration as number.'
  entry_time:
    type: int
    description: 'The UNIX timestamp when this downtime was added.'
  fixed:
    type: bool
    default: 'flexible. Details in the advanced topics chapter'
    description: 'Whether the downtime is fixed (true) or flexible (false). Defaults to flexible. Details in the advanced topics chapter.'
  triggers:
    type: list
    description: 'List of downtimes which should be triggered by this downtime.'
